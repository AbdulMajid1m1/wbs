...
const WmsProfitLoss = () => {
  ...
  const handleSerialScan = async (e) => {
    ...
    try {
      ...
      const { data: validationData } = await userRequest.post("/validateItemSerialNumberForJournalProfitLostCLDets", { itemSerialNo });
      ...
      const updateDataResponse = await userRequest.put("/updateWmsJournalProfitLostClQtyScanned", {
      ...
      const insertResponse = await userRequest.post("/insertJournalProfitLostClDets", [dataToInsert]);
          ...
          <div className="w-full sm:w-1/2 lg:2/3 px-6 bg-gray-400 bg-opacity-20 bg-clip-padding backdrop-filter backdrop-blur-sm text-white z-50 py-4  rounded-lg" style={{ minHeight: '550px' }}>
            <div className="w-full font-semibold p-6 shadow-xl rounded-md text-black bg-[#F98E1A] text-xl mb:2 md:mb-5">
              ...
              <div className='flex justify-between items-center gap-2 text-xs sm:text-xl'>
                ...
                <h2 className='text-center text-[#fff]'>Journal Profit and Loss</h2>
