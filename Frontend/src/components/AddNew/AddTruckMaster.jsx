...
const AddTruckMaster = ({ inputs, title,
    method, apiEndPoint
}) => {
    ...
    const handleSubmit = async event => {
        ...
        try {
            ...
            const data = {
                PlateNo: event.target.PlateNo.value,
                BarcodeSerialNumber: event.target.BarcodeSerialNumber.value,
                TransportationCompanyName: event.target.TransportationCompanyName.value,
              };
            
            userRequest.post('/insertTruckMasterData', [data])
            .then((response) => {
              setIsLoading(false);
