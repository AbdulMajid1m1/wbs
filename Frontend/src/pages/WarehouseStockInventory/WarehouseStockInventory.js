...
const WarehouseStockInventory = () => {
    ...
    return (
        <div>
            ...
            <UserDataTable data={data} title="Stock Inventory (Warehouse Operation)" columnsName={WarehouseWmsInventoryColumn} backButton={true}
            ...
            <UserDataTable data={filteredData} title="Stock Inventory " columnsName={WarehouseWmsInventoryColumn} backButton={true}
                actionColumnVisibility={false}
                buttonVisibility={false}
