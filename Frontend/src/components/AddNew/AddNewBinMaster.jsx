...
import { TblBinMasterUpdateColumn } from "../../utils/formSource";
import userRequest from "../../utils/userRequest";
import CustomSnakebar from "../../utils/CustomSnakebar";

const AddNewBinMaster = ({ inputs, title,
    method, apiEndPoint
}) => {
    ...
    const handleSubmit = async event => {
        ...
        try {
            ...
            const data = {
                ...
                BinNumber: event.target.BinNumber.value,
                ZoneType: event.target.ZoneType.value,
                BinHeight: event.target.BinHeight.value,
                BinRow: event.target.BinRow.value,
                BinWidth: event.target.BinWidth.value,
                BinTotalSize: event.target.BinTotalSize.value,
                BinType: event.target.BinType.value,
              };
            
            userRequest.post('/insertBinLocationData', [data])
            .then((response) => {
              setIsLoading(false);
...
export default AddNewBinMaster;
