...
const TblDispatchingCL = () => {
    ...
    return (
        <div>
            ...
            <UserDataTable data={alldata} addNewNavigation="/tbl-new-location" title="TBL DISPATCHING CL " columnsName={TblDispatchingCLColumn} backButton={true} uniqueId="PACKINGSLIPID"/>
