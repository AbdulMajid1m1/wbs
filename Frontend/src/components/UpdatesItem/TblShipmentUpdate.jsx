...
const TblShipmentUpdate = ({ inputs, title,
  ...
  const handleSubmit = async event => {
    ...
    try {
        ...
        for (const input of TblShipmentReceivedClInput) {
        ...
        userRequest
            .put(`/updateShipmentRecievedDataCL?${queryParameters}`)
            .then((response) => {
                setIsLoading(false);
                        ...
                        <div className="bottom">
                            ...
                            <div className="right">
                                <form onSubmit={handleSubmit} id="myForm" >
                                    {TblShipmentReceivedClInput.map((input) => (
...
export default TblShipmentUpdate;
